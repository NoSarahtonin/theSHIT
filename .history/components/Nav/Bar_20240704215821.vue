    ...
    <div class="flex flex-wrap items-center h-16 justify-beteen">
      <div class="flex items-center justify-start w-2/3 gap-8 px-12">
        <NuxtLink to="/" class="text-shadow-sm"
          ...
          ></NuxtLink
        >
        <input type="search" id="searchBar" class="w-40 p-2 mt-[1px] hover:w-80 active:w-80 focus:active:w-80 border-primary-100 bg-[#ffffff] hover:border-primary-200 focus:border-primary-200 active:border-primary-200 focus:outline-secondary-800 border rounded-md active:outline-secondary-800" placeholder="Search here...">
      </div>
