    ...
    <div class="flex flex-wrap items-center h-16 justify-beteen">
      <div class="flex items-center justify-start w-2/3 px-12">
        <NuxtLink to="/" class="text-shadow-sm"
          ...
          ></NuxtLink
        >
        <input type="search" id="searchBar" class="w-40 focus:active:w-80 border-primary-400 hover:focus:active:border-primary-300 focus:active:outline-secondary-800" placeholder="Search here...">
      </div>
